                    ...
                    Row(
                      ...
                      children: [
                        ...
                        LabelFormRegisterHalf(
                            nama: (controller.selectedTime == null)
                                ? '-'
                                : controller.getDate(controller.selectedTime!))
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        ...
                        GetBuilder<CiCoController>(
                            builder: (con) => DropDownHalf(
                                dropdownValue: con.selectedOutlet,
                                opsi: con.outlets
                                    .map((e) => e.namaOutlet!)
                                    .toList(),
                                function: (val) {
                                  con.selectedOutlet = val;
                                })),
                      ],
                    ),
                    SizedBox(
                              ...
                              onPressed: () async {
                                if (selectedOutlet != null &&
                                  ...
                                  if (getDate(selectedTime!) ==
                                    ...
                                    List isThere = result
                                        .where((item) =>
                                            item.namaOutlet == selectedOutlet)
                                        .toList();
                                    if (isThere.length == 0) {
                                  ...
                                  notif(
                                      "Salah", "Pilih bulan dan outlet dahulu");
                                }
                              },
                              child: Text(
                                "Tambah",
